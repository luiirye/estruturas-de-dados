//Manipula��o de Listas duplamente encadeadas
...
int buscaLista (node *, int);
void imprimeLista(node *);
node *ultimo (node *);
void imprimeContrario (node *);
   	...
   	do{
		...
		printf("MENU DE OP��ES\n");
      	...
      	switch(op){
	        ...
	        break;
         	case 'b': //busca um elementos na lista
...
int buscaLista (node *lista, int valor){
}
...
void imprimeContrario (node *aux){
}
